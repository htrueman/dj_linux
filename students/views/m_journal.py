...
class JournalView(TemplateView):
    template_name = 'students/m_journal.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        for student in queryset:
            ...
            try:
                m_journal = MonthJournal.objects.get(student=student, date=month)
            except Exception:
                m_journal = None
            ...
            for day in range(1, number_of_days+1):
                days.append({
                    'day': day,
                    'present': m_journal and getattr(m_journal, 'present_day%d' % day, False) or False,
    ...
    def post(self, request, *args, **kwargs):
        ...
        m_journal = MonthJournal.objects.get_or_create(student=student,
             date=month)[0]

        # set new presence on journal for given student and save result
        setattr(m_journal, 'present_day%d' % current_date.day, present)
        m_journal.save()
